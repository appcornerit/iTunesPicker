...
You want to share your apps or build your AppCornerKit framework from scratch, take a look to [AppCorner Social](https://github.com/appcornerit/AppCorner-Social), iTunesPicker can share apps on AppCorner Social.
